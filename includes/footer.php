...
<script src="<?php echo $_DOMAIN; ?>js/function.js"></script>
<footer class="text-center lg:text-left bg-gray-100 text-gray-600">
    ...
    <div class="w-full flex items-center justify-center">
        <div class="w-[1440px] h-full mx-6 py-10 text-center md:text-left">
    ...
    <div class="text-center p-6 bg-gray-200">
        ...
        <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Hoang</a>
    </div>
</footer>
</body>